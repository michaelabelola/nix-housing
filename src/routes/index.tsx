...
import {RealEstateInstance} from "#/library/real_estate/RealEstateInstance.ts";
import {type FetchError, NixFetch} from "#/library/util/fetch.ts";
...
nixRequest.queryPropertyListing().then((response) => {
    console.log("Queried listings:", response)
}).catch((error: FetchError) => {
    console.error("Error querying listings:", JSON.stringify(error))
})
